...
const Option = forwardRef<HTMLDivElement, OptionProps>(
  (
    ...
    return (
      <ElementType tabIndex={tabIndex} ref={ref} href={href} className="bg-none p-0 outline-none border-0" style={{width: "100%"}}>
        <Flex
          {...props}
          fillWidth
          vertical="center"
        ...
        >
          ...
          <Flex
            ...
            direction="column"
          >
            <Text onBackground="neutral-strong" variant="label-default-sm">
              {label}
            </Text>
            {description && (
