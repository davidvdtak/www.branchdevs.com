    ...
    const renderCalendarGrid = () => {
      ...
      for (let i = 0; i < firstDay; i++) {
        ...
        days.push(
          ...
          >
            <Button fillWidth weight="default" variant="tertiary" size="md" type="button" disabled>
              {prevMonthDay}
            </Button>
          </Flex>,
        );
        ...
        days.push(
          <Flex paddingY="2" key={`day-${currentYear}-${currentMonth}-${day}`}>
            <Flex
              ...
              leftRadius={isFirstInRange ? "md" : undefined}
              rightRadius={isLastInRange ? "md" : undefined}
            >
              <Button
                fillWidth
            ...
            <>
              ...
              <Flex fillWidth direction="column" horizontal="center" gap="8">
                ...
                {timePicker && selectedTime && (
                  <Text variant="label-default-sm" onBackground="neutral-weak">
